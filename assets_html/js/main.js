...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // แสดง dropdown-content เมื่อ mouseenter
    dropdownToggle.addEventListener('mouseenter', function () {
        dropdownContent.style.display = 'block'; // แสดงเมนู
    });

    // ซ่อน dropdown-content เมื่อ mouseleave ออกจาก dropdown และ dropdown-content
    dropdownToggle.addEventListener('mouseleave', function () {
        setTimeout(function () {
            if (!dropdownContent.matches(':hover')) {
                dropdownContent.style.display = 'none'; // ซ่อนเมนู
            }
        }, 200); // เพิ่มดีเลย์เล็กน้อยเพื่อให้แน่ใจว่า mouseleave ถูกเรียกใช้หลังจาก mouseenter ใน dropdown-content
    });

    // แสดง dropdown-content เมื่อ mouseenter ที่ dropdown-content
    dropdownContent.addEventListener('mouseenter', function () {
        dropdownContent.style.display = 'block'; // แสดงเมนู
    });

    // ซ่อน dropdown-content เมื่อ mouseleave ออกจาก dropdown-content
